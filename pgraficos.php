  ...
  <script>
    async function actualizar() {
      try {
        ...
        let t = await r.text();
        // Parsear T1, T2 y T3 desde la respuesta con formato:
        // "T1 Dist: XX.X cm | Llenado: YY.Y% | Litros: ZZ.Z\nT2 Dist: ...\nT3 Dist: ..."
        ...
        // Calcular porcentaje y litros a partir de la distancia (mismos parámetros que en el servidor)
        ...
        // Si se recibió distancia, recalcular usando la distancia (priorizar distancia sobre el campo llenado)
        if (m1) {
        ...
        litros2 = Math.round(litros2);
        litros3 = Math.round(litros3);
        ...
        // Actualizar círculo de progreso con el porcentaje de T1
        let circle1 = document.getElementById("progress1");
        let total1 = 327.0; // Circunferencia aproximada para r=52
        ...
        // Actualizar círculo de progreso con el porcentaje de T2
        ...
        // Actualizar círculo de progreso con el porcentaje de T3
        ...
        // asegurar T3 también en caso de error
